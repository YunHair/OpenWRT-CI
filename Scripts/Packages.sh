...
UPDATE_PACKAGE "luci-app-unblockneteasemusic" "YunHair/luci-app-unblockneteasemusic" "$([[ $WRT_REPO == *"lede"* ]] && echo "master" || echo "js")"
...
UPDATE_PACKAGE "luci-app-multi-frpc" "YunHair/luci-app-multi-frpc" "main"
