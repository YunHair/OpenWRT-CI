...
UPDATE_PACKAGE "yunhair-package" "YunHair/openwrt-package" "main" "" "luci-app-advancedplus lucky luci-app-lucky oaf open-app-filter luci-app-oaf wrtbwmon luci-app-wrtbwmon"
